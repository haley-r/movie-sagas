...
This full-stack react application displays movies from a database-posters on the home page, and details and genres for a specific movie upon clicking on its poster. Users can edit movie information on an edit page, which is saved to the database.
